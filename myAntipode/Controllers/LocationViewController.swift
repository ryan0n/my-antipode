...
// MARK: - Primary
class LocationViewController: UITableViewController, CityPickerViewControllerDelegate {
    ...
    @IBAction func addButtonPressed(_ sender: UIBarButtonItem) {
        ...
        self.cityPicker.showCityPicker(ViewController: self, backgroundColor: UIColor.clear, blurView_hidden: false)
